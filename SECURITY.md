...
This project is a thin local wrapper around Codex CLI, tmux, SSH, and Tailscale.
Vulnerabilities in those upstream projects should also be reported through the
upstream project's security process.
